...
/*	 function findWeatherRange() {
		 $http.get('/weathers/search/findByHour',{
			    params: {   hour: 21, 
	...
	// $scope.FromDate = new Date();
	 ...
	 function findWeatherRange2() {
		 $http.get('/tasks/search/findByDate',{
			    params: {   date:  '2017-09-20 16:58:13', //user sto ja vnel
			    			enddate: '2017-09-20 18:58:13'
			    	 		}
		 }).
         success(function (data) {
         	console.log(data);
